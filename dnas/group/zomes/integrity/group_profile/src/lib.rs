...
pub fn validate(op: Op) -> ExternResult<ValidateCallbackResult> {
    match op.flattened::<EntryTypes, LinkTypes>()? {
        ...
        FlatOp::RegisterCreateLink {
            ...
            LinkTypes::GroupProfileUpdates => validate_create_link_group_profile_updates(
                action,
                base_address,
                target_address,
                tag,
            ...
            LinkTypes::GroupProfiles => {
                validate_create_link_group_profiles(action, base_address, target_address, tag)
            }
        },
        FlatOp::RegisterDeleteLink {
            ...
            LinkTypes::GroupProfileUpdates => validate_delete_link_group_profile_updates(
                action,
                original_action,
                base_address,
                target_address,
            ...
            LinkTypes::GroupProfiles => validate_delete_link_group_profiles(
                action,
                original_action,
                base_address,
                target_address,
        ...
        FlatOp::StoreRecord(store_record) => {
            match store_record {
                ...
                OpRecord::CreateLink {
                    ...
                    LinkTypes::GroupProfiles => validate_create_link_group_profiles(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                OpRecord::DeleteLink {
                    ...
                    match link_type {
                        LinkTypes::GroupProfileUpdates => {
                            validate_delete_link_group_profile_updates(
                                action,
                                create_link.clone(),
                                base_address,
